...
<style>
    ...
    .tab-btn {
        ...
        position: relative;
        transition: 0.3s;
        flex: 0 0 auto; /* Stop tabs shrinking */
    }
    ...
    .form-grid {
        display: grid;
        /* Changed fixed 400px to dynamic sizing */
    ...
    .template-grid {
        display: grid;
        grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); /* Smaller minmax for mobile */
        gap: 15px;
        margin-top: 15px;
    }
    ...
    .msg-item {
        ...
        flex-wrap: wrap; /* Allow wrap for buttons on mobile */
        gap: 15px;
    }
    .msg-item:hover {
    ...
    @media (max-width: 768px) {
        .banner-area {
            height: 180px; /* Smaller banner on mobile */
        }
        ...
        #security .input-group[style*="justify-content: space-between"] {
            flex-direction: column;
            gap: 20px;
        }
    }
