...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'update_profile') {
        ...
        $activeTab = 'profile'; // Stay on profile tab
    }
        ...
        <?php if ($activeTab === 'profile'): ?>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="helper-text">This email will be displayed on your profile.</div>
                </div>
        ...
        <?php if ($activeTab === 'security'): ?>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="helper-text">Required to verify your identity.</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="helper-text">Make sure it's at least 8 characters including a number and a lowercase letter.</div>
                </div>
...
<script>
    // Simple preview for the image upload (Only runs if element exists)
