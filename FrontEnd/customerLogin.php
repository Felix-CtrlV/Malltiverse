...
<body>
    <div class="container">
        <div class="left-panel login-visual">
            <div class="top-row">
                <div class="logo-icon"> 
                    <img class="logo-icon" src="assets/images/MalltiverseLogo.jpg" alt="Logo" style="width:100%; object-fit:contain;">
                </div>
        ...
        <div class="right-panel">
            ...
            <div class="social-login">
                <button type="button" class="social-btn"
                    onclick="window.location.href='utils/google_oauth.php?type=customer&return_url=<?= urlencode($redirectUrl) ?>'">
                    <i class="fa-brands fa-google" style="color:#DB4437;"></i> Google
                </button>
                <button type="button" class="social-btn"
                    onclick="window.location.href='utils/github_oauth.php?type=customer&return_url=<?= urlencode($redirectUrl) ?>'">
